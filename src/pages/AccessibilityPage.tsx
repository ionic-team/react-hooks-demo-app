    ...
    <IonPage>
      ...
      <IonContent>
        <IonCard>
          ...
          <IonCardContent>
            <p>isAvailable on {platform}: {JSON.stringify(availableFeatures.isScreenReaderAvailable)} </p>
            {availableFeatures.isScreenReaderAvailable && <p>isScreenReaderEnabled: {JSON.stringify(isScreenReaderEnabled)}</p>}
          </IonCardContent>
        </IonCard>
        ...
        <IonCard>
          ...
          <IonCardContent>
            <p>isAvailable on {platform}: {JSON.stringify(availableFeatures.speak)} </p>
            {availableFeatures.speak && (
              <div>
                <div>
                  <IonInput value={textToSpeak} onIonChange={e => setTextToSpeak(e.detail.value!)} placeholder='Enter text to speak' />
                </div>
                <div>
